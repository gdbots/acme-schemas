...
export default class CommandV1Mixin extends SystemUtils.mixinClass(Mixin)
{
  /**
   * {@inheritdoc}
   */
  ...
  getFields() {
    return [
      Fb.create('command_id', TimeUuidType.create())
        .required()
        .build(),
       ...
       */
      Fb.create('expected_etag', StringType.create())
        .maxLength(100)
        .pattern('^[\\w\\.:-]+$')
        .build(),
      /*
