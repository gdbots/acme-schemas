<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/forms/command/update-form/1-0-0.json#
...
final class UpdateFormV1 extends AbstractMessage implements
    UpdateForm,
    GdbotsPbjxCommandV1,
    GdbotsNcrUpdateNodeV1
{
    ...
    {
        return new Schema('pbj:acme:forms:command:update-form:1-0-0', __CLASS__,
            [],
            [
