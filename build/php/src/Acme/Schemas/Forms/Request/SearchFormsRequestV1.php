...
final class SearchFormsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:acme:forms:request:search-forms-request:1-0-0';
    const SCHEMA_CURIE = 'acme:forms:request:search-forms-request';
    const SCHEMA_CURIE_MAJOR = 'acme:forms:request:search-forms-request:v1';
    const MIXINS = [
