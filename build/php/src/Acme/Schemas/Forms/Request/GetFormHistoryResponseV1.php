...
final class GetFormHistoryResponseV1 extends AbstractMessage implements
    ...
    GdbotsPbjxGetEventsResponseV1
{
    ...
    {
        return new Schema('pbj:acme:forms:request:get-form-history-response:1-0-0', __CLASS__,
            [],
            [
