...
final class SearchFormsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:acme:forms:request:search-forms-response:1-0-0';
    const SCHEMA_CURIE = 'acme:forms:request:search-forms-response';
    const SCHEMA_CURIE_MAJOR = 'acme:forms:request:search-forms-response:v1';
    const MIXINS = [
