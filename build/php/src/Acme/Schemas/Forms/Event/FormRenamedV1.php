<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/forms/event/form-renamed/1-0-0.json#
...
final class FormRenamedV1 extends AbstractMessage implements
    FormRenamed,
    GdbotsPbjxEventV1,
    ...
    GdbotsEnrichmentsTimeSamplingV1
{
    ...
    {
        return new Schema('pbj:acme:forms:event:form-renamed:1-0-0', __CLASS__,
            [],
            [
