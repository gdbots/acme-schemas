...
export default {
  'acme:forms:command:send-submission:v1': () => import('@gdbots/acme-schemas/acme/forms/command/SendSubmissionV1'),
  'acme:forms:event:submission-received:v1': () => import('@gdbots/acme-schemas/acme/forms/event/SubmissionReceivedV1'),
  'acme:forms:node:form:v1': () => import('@gdbots/acme-schemas/acme/forms/node/FormV1'),
  'acme:forms:request:search-forms-request:v1': () => import('@gdbots/acme-schemas/acme/forms/request/SearchFormsRequestV1'),
  'acme:forms:request:search-forms-response:v1': () => import('@gdbots/acme-schemas/acme/forms/request/SearchFormsResponseV1'),
  'acme:iam:command:patch-user:v1': () => import('@gdbots/acme-schemas/acme/iam/command/PatchUserV1'),
  'acme:iam:command:patch-users:v1': () => import('@gdbots/acme-schemas/acme/iam/command/PatchUsersV1'),
  'acme:iam:event:user-patched:v1': () => import('@gdbots/acme-schemas/acme/iam/event/UserPatchedV1'),
  'acme:iam:node:alexa-app:v1': () => import('@gdbots/acme-schemas/acme/iam/node/AlexaAppV1'),
  'acme:iam:node:android-app:v1': () => import('@gdbots/acme-schemas/acme/iam/node/AndroidAppV1'),
  'acme:iam:node:apple-news-app:v1': () => import('@gdbots/acme-schemas/acme/iam/node/AppleNewsAppV1'),
  'acme:iam:node:browser-app:v1': () => import('@gdbots/acme-schemas/acme/iam/node/BrowserAppV1'),
  'acme:iam:node:email-app:v1': () => import('@gdbots/acme-schemas/acme/iam/node/EmailAppV1'),
  'acme:iam:node:ios-app:v1': () => import('@gdbots/acme-schemas/acme/iam/node/IosAppV1'),
  'acme:iam:node:role:v1': () => import('@gdbots/acme-schemas/acme/iam/node/RoleV1'),
  'acme:iam:node:slack-app:v1': () => import('@gdbots/acme-schemas/acme/iam/node/SlackAppV1'),
  'acme:iam:node:sms-app:v1': () => import('@gdbots/acme-schemas/acme/iam/node/SmsAppV1'),
  'acme:iam:node:twitter-app:v1': () => import('@gdbots/acme-schemas/acme/iam/node/TwitterAppV1'),
  'acme:iam:node:user:v1': () => import('@gdbots/acme-schemas/acme/iam/node/UserV1'),
