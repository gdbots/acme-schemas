...
const M = SearchFormsResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:forms:request:search-forms-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:forms:request:search-forms-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:forms:request:search-forms-response:v1';
M.prototype.MIXINS = M.MIXINS = [
  ...
  'gdbots:forms:mixin:search-forms-response:v1',
