...
export default class FormRenamedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:acme:forms:event:form-renamed:1-0-0', FormRenamedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(FormRenamedV1);
MessageResolver.register('acme:forms:event:form-renamed', FormRenamedV1);
Object.freeze(FormRenamedV1);
Object.freeze(FormRenamedV1.prototype);
