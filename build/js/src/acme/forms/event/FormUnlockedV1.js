...
export default class FormUnlockedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:acme:forms:event:form-unlocked:1-0-0', FormUnlockedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(FormUnlockedV1);
MessageResolver.register('acme:forms:event:form-unlocked', FormUnlockedV1);
Object.freeze(FormUnlockedV1);
Object.freeze(FormUnlockedV1.prototype);
