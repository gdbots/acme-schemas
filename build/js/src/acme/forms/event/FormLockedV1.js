// @link http://acme-schemas.gdbots.io/json-schema/acme/forms/event/form-locked/1-0-0.json#
...
export default class FormLockedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:acme:forms:event:form-locked:1-0-0', FormLockedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(FormLockedV1);
MessageResolver.register('acme:forms:event:form-locked', FormLockedV1);
Object.freeze(FormLockedV1);
Object.freeze(FormLockedV1.prototype);
