...
export default class SendSubmissionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:forms:command:send-submission:1-0-0', SendSubmissionV1,
      [
...
MessageResolver.register('acme:forms:command:send-submission', SendSubmissionV1);
